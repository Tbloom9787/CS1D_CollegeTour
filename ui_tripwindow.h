...
{
public:
    QListWidget *totalsListWidget;

    void setupUi(QDialog *TripWindow)
    {
        if (TripWindow->objectName().isEmpty())
            TripWindow->setObjectName(QStringLiteral("TripWindow"));
        TripWindow->resize(437, 526);
        TripWindow->setWindowOpacity(0.92);
        TripWindow->setStyleSheet(QLatin1String("QToolTip {\n"
...
"}\n"
""));
        totalsListWidget = new QListWidget(TripWindow);
        totalsListWidget->setObjectName(QStringLiteral("totalsListWidget"));
        totalsListWidget->setGeometry(QRect(19, 30, 401, 451));
    ...
    {
        TripWindow->setWindowTitle(QApplication::translate("TripWindow", "Trip Totals", Q_NULLPTR));
    } // retranslateUi
